...
(titre, description_courte, contenu, id_categorie, id_auteur, image) 
VALUES
(
...
(
    ...
    'Le DevFest (Developer Festival) est un événement annuel mondial destiné aux développeurs...',
    1,
    2,
...
(
    'GalsenDEV',
    'GalsenDEV est une communauté sénégalaise de développeurs...',
...
(
    ...
    'L’École Supérieure Polytechnique de Dakar (ESP) est un établissement...',
    'L’École Supérieure Polytechnique de Dakar (ESP) est un établissement public...',
    4,
    3,
